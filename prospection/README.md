# Plan 60 jours — 3 000 € net par mois avec l'expertise en valeur vénale

Document **interne**, non publié sur le site (exclu de l'indexation via
`robots.txt`). Il ne contient aucune donnée personnelle : le dépôt est public.
...
Un particulier qui a besoin d'une expertise en cherche une **une fois dans sa
...
Tout le plan consiste à en trouver 4.

## L'entonnoir réaliste
...
Ces taux supposent **l'appel après le mail**. Sans appel, il faut diviser le
résultat final par trois : le mail seul ne suffit pas sur cette cible.

---

## Le calendrier

### Semaines 1 et 2 — fabriquer les outils

- [ ] **Rapport-modèle anonymisé** à partir d'un rapport réel déjà livré. Voir
      la procédure d'anonymisation dans `trame-rapport.md`. **C'est la pièce
      maîtresse** : c'est lui qui vend, pas les mails.
...
- [ ] Tenir le fichier de suivi à jour après chaque appel. Sans lui, on rappelle
      deux fois les mêmes et jamais les autres.

### Semaines 4 à 8 — livrer et enclencher la répétition
...
- [ ] Vers la semaine 6, ouvrir un second front à faible effort : proposer aux
      ...
      lancer **qu'une fois** le démarchage prescripteurs terminé.

---

## Le seul indicateur à suivre

> **Nombre de prescripteurs ayant confié au moins une mission.**

- 1 à 2 → le rapport-modèle ou le discours ne convainc pas : demander pourquoi
  à trois interlocuteurs, franchement. Ils le diront.
- 3 → on y est presque, continuer le démarchage.
- **4 et plus → l'objectif est atteint et il se répète tout seul.**

Ne pas suivre le chiffre d'affaires au jour le jour : il est en retard d'un mois
sur l'effort, et il décourage pour rien pendant les trois premières semaines.
...
3. **Baisser le prix.** Un forfait bas inquiète un notaire : il y lit un travail
   bâclé qu'il devra défendre. Le prix ne se négocie pas, le périmètre oui.
4. **Envoyer la plaquette en pièce jointe au premier mail.** Elle finit en
   indésirable. On met le lien, la pièce jointe vient au second échange.
5. **Arrêter le démarchage dès la première mission.** C'est le réflexe naturel et
   c'est l'erreur qui coûte le mois suivant. Les 3 heures hebdomadaires
   continuent jusqu'à 4 prescripteurs actifs.

## Deux points à vérifier avant de démarrer

- **Le contrat avec BSK Immobilier.** L'expertise en valeur vénale est une
  activité distincte de l'entremise et n'entre pas dans le champ de la loi
  Hoguet, mais la clause d'exclusivité ou de non-concurrence du contrat d'agent
  commercial doit être relue avant de facturer en direct.
- **Le statut de facturation.** Vérifier sous quel statut les honoraires
  d'expertise sont encaissés (BNC séparé de l'activité d'agent commercial), et
  le seuil de franchise de TVA de l'article 293 B du CGI, qui se calcule sur
...
`premiere_mission` · `ca_ttc` · `note`

> **Ce fichier ne doit jamais être rempli dans le dépôt** : il est public, et il
